...
==399== Command: ./test -r xml "test_destructor"
==399== 
==399== 
==399== HEAP SUMMARY:
==399==     in use at exit: 0 bytes in 0 blocks
==399==   total heap usage: 1,667 allocs, 1,667 frees, 216,576 bytes allocated
==399== 
...
<Catch name="test">
  <Group name="test">
    <TestCase name="test_pure_virtual" tags="[valgrind][weight=10]" filename="tests/tests.cpp" line="108">
      <Failure filename="tests/tests.cpp" line="53">
        Pixels differ at (18, 70)!
Sol: (0, 0, 0);  actual: (240, 1, 0.5)
...
==403== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==403== Using Valgrind-3.13.0 and LibVEX; rerun with -h for copyright info
==403== Command: ./test -r xml "test_slicing"
==403== 
==403== 
==403== HEAP SUMMARY:
==403==     in use at exit: 0 bytes in 0 blocks
==403==   total heap usage: 1,794 allocs, 1,794 frees, 1,759,556 bytes allocated
==403== 
...
This report was generated for **dpeng4** using **822aa38e4b3782bcefbc28b20cdd778492d44974** (from **February 11th 2019, 12:15:00 am**)
